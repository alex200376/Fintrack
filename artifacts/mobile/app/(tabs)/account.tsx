...
export default function AccountScreen() {
  ...
  const { fetchTransactions, fetchCategories, fetchBudgets, createTransaction, createCategory, createBudget } = useFinance();
  ...
  return (
    <>
      <ScrollView
        ...
        contentContainerStyle={{ paddingTop: topPad + spacing.md, paddingBottom: bottomPad, gap: spacing.md, paddingHorizontal: spacing.md }}
      ...
      >
        ...
        <View style={[styles.card, { backgroundColor: colors.surface }]}>
          ...
          <View style={[styles.sep, { backgroundColor: colors.borderLight }]} />
          <Text style={[styles.rowLabel, { color: colors.textSecondary, marginBottom: 2 }]}>Or choose a gradient theme:</Text>
        ...
        <View style={[styles.noteCard, { backgroundColor: colors.surface }]}>
          ...
          <Text style={[styles.noteText, { color: colors.textSecondary }]}>
            Profile is stored only on this device. Transactions are stored on the server.
          </Text>
        </View>
      </ScrollView>
